...
public class ArduinoRadarProgramKUCUK extends PApplet {
    ...
    public void drawObject() {
      ...
      pixsDistance = iDistance*22.5f; // covers the distance from the sensor from cm to pixels
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "ArduinoRadarProgramKUCUK" };
    if (passedArgs != null) {
